    ...
    <div className="flex h-dvh bg-slate-900">
      ...
      <main className="flex-1 min-w-0 flex flex-col">
        <div className="flex-1 min-h-0 relative">
          ...
          {/* Side Panel */}
          {panel && <div className="absolute top-3 left-3 z-10 w-72 max-h-[calc(100dvh-10rem)] bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200/80 overflow-y-auto">
            <div className="p-4 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setPanel(false)} className="text-slate-300 hover:text-slate-500">✕</button>
              </div>
              ...
              <div className="grid grid-cols-2 gap-1.5 pt-1">
                ...
                <button onClick={() => setPanel(false)} className="flex items-center justify-center gap-1.5 text-[11px] bg-slate-50 hover:bg-slate-100 rounded-xl px-3 py-2 text-slate-600 border border-slate-200 transition-all">
                  🗺️ Pantalla completa
                </button>
          ...
          {!panel && <button onClick={() => setPanel(true)} className="absolute top-3 left-3 z-10 bg-white/80 backdrop-blur rounded-xl shadow px-3 py-2 text-xs font-semibold text-slate-600 hover:bg-white transition-all">
